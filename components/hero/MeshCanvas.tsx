...
const MESH_PALETTES = {
  /* Site-wide canvas — cool ice blues for approach / services / strategy */
  default: {
    tl: 0x1f4287,
    tr: 0x4c68a9,
    bl: 0x0c2b62,
  ...
  /* Hero-only — navy institutional with gold warmth kept away from the header */
  institutional: {
    tl: 0x001428,
    tr: 0x14283c,
    bl: 0x1f2f3f,
...
type MeshPalette = keyof typeof MESH_PALETTES;
...
export function MeshCanvas({
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      const colors = MESH_PALETTES[variant];
